...
exports.sendConfirmAccountEmail = async (user,req) => {
  var formatedUrl = `${req.protocol}://${req.url.path}/api/user/${user._id}/confirm/${user.confirmHash}`
    const msg = {
        to: user.email,
        from: 'models@squaremm.com',
        subject: 'Please confirm your email',
        text: `Welcome to SQUARE! Please verify your email by clicking this link: ${formatedUrl}`,
        html: `Welcome to SQUARE! <a href='${formatedUrl}'>Please verify your email</a>`,
      };
      send(msg);
};
